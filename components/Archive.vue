        ...
        <ul class="archive__list">
            <li class="archive__item" v-for="item of archiveList" :key="item.year">
                ...
                <div v-for="(subItem, key) of item.list" :key="key" class="archive__sub-item">
                    <a class="archive__leaf-item" v-for="leafItem in subItem" :key="leafItem.key" :href="leafItem.path">
                        <span class="archive__data">{{ leafItem.date }}</span>
